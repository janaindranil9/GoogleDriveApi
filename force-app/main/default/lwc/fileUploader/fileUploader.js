...
import createChildRecords from '@salesforce/apex/FileUploaderController.createChildRecords';
...
export default class FileUploader extends LightningElement {
  ...
  validateFileSize(file) {
    ...
    return fileSizeInMB >= 5 && fileSizeInMB <= 10;
  }
  ...
  uploadFile() {
    ...
    reader.onloadend = () => {
      ...
      const base64Data = 'base64,' + btoa(fileContents);
